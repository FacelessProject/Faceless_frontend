...
const initFaceless = async () => {
  ...
  const provider = new WsProvider('wss://45.32.60.117:443');
  ...
  let client = new FacelessClient(api, alice);
...
export { useSubstrate, initFaceless, FacelessClient };
